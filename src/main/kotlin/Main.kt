            ...
            callbackQuery("Задачи на сегодня") {
                bot.sendMessage(
                    ...
                    replyMarkup = InlineKeyboardMarkup.create(
                        ...
                        listOf(
                            InlineKeyboardButton.CallbackData(text = "Дочитать книгу", callbackData = "showAlert")
                        ),
                        listOf(
                            InlineKeyboardButton.CallbackData(text = "Приготовить ужин", callbackData = "showAlert")
                        ),
                        listOf(
